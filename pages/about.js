...
export default function About() {
  return (
    <MainLayout title="Welcome Homepage">
      <div
        className="grid min-h-[300px] w-full place-items-center bg-light mw-100 bg-no-repeat bg-cover"
        style={{
          backgroundImage:
            'url(https://i.pinimg.com/564x/a4/ae/6f/a4ae6ff16340e6ea4540a4decdcdc050.jpg)',
        }}
      >
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          <h1 className="mb-4 text-lg leading-none font-bold text-gray-900 md:text-2xl lg:text-3xl dark:text-white">
            About Us
          </h1>
          <p className="ext-xs text-gray-900 dark:text-white">
      ...
      <div className="grid min-h-[400px] mt-2 items-center">
        <div className="flex flex-row items-center justify-center">
          <div className="h-72 w-80 m-2 p-2 bg-gray-500 ml-8">
            <svg
